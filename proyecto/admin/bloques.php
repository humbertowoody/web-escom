...
define('TITULO_PAGINA', 'Admin - Bloques');
...
<div id="bloques">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="acciones">
              <a href="/acciones/admin/eliminar-bloque.php?id=<?php echo $bloque->id; ?>">❌</a>
              <a href="/admin/formulario-bloque.php?id=<?php echo $bloque->id; ?>">✏️</a>
            </td>
          </tr>
        <?php
        }
  ...
  <a class="agregar-bloque" href="/admin/formulario-bloque.php">➕ Agregar Bloque</a>
</div>
