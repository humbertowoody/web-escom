...
define('TITULO_PAGINA', 'Profesor - Temas');
...
<div id="temas">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="acciones">
              <a href="/acciones/profesor/eliminar-tema.php?id=<?php echo $tema->id; ?>">❌</a>
              <a href="/profesor/formulario-tema.php?id=<?php echo $tema->id; ?>">✏️</a>
            </td>
          </tr>
        <?php
        }
  ...
  <a class="agregar-tema" href="/profesor/formulario-tema.php">➕ Agregar Tema</a>
</div>
