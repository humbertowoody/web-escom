...
define('TITULO_PAGINA', 'Profesor - SubTemas');
...
<div id="subtemas">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="acciones">
              <a href="/acciones/profesor/eliminar-subtema.php?id=<?php echo $subtema->id; ?>">❌</a>
              <a href="/profesor/formulario-subtema.php?id=<?php echo $subtema->id; ?>">✏️</a>
            </td>
          </tr>
        <?php
        }
  ...
  <a class="agregar-subtema" href="/profesor/formulario-subtema.php">➕ Agregar SubTema</a>
</div>
